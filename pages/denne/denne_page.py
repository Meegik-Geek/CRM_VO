...
from pages.denne.input_applicant_den import InputApplicantDen
from pages.denne.input_sprava_den import InputSpravaDen
from pages.denne.input_pilga_den import InputPilgaDen
from pages.denne.druk_document_den import DrukDocumentDen
from pages.denne.list_vstupnik_den import ListVstupnikDen

class InputDenPage(QMainWindow):
    def __init__(self):
        super(InputDenPage, self).__init__()
        self.setWindowTitle("CRM Вступ.Офіс - Введення вступників денної форми навчання")
    ...
    def show_default_buttons(self):
        label = QLabel("Денна форма навчання", self)
