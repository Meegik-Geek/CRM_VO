...
class ListExamDen(BaseTableWidget):
    def __init__(self):
        super().__init__(
            table_name="public.entrance_examinations_day",
            headers=[
            ...
            sql_queries={
                "SELECT": """
                    ...
                    FROM public.entrance_examinations_day
                    ORDER BY id
                """,
                
                "DELETE": "DELETE FROM public.entrance_examinations_day WHERE id = %s"
            },
            columns_name = [
