...
class ListSpravaDenScor(BaseTableWidget):
    def __init__(self):
        super().__init__(
            table_name="public.personal_case_day_scor",
            headers=[
               "ID",
            ...
            sql_queries={
                "SELECT": """
                    ...
                    FROM public.personal_case_day_scor
                    ORDER BY id
                """,
                
                "DELETE": "DELETE FROM public.personal_case_day_scor WHERE id = %s"
            },
            columns_name = [
            ...
            label_text="Список особових справ (денна) скорочена",
            default_values={
                "number_sprava": "",
                "kod_galuzi": "",
                "name_specialnosti": "",
