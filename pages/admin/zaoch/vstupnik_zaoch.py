...
class ListVstupnikZao(BaseTableWidget):
    def __init__(self):
        super().__init__(
            table_name="applicant_personal_data_evening",
            headers=[
            ...
            sql_queries={
                "SELECT": """
                    ...
                    FROM applicant_personal_data_evening
                    ORDER BY id
                """,
                
                "DELETE": "DELETE FROM applicant_personal_data_evening WHERE id = %s"
            },
            columns_name = [
            ...
            label_text="Список вступників (заочна форма)",
            default_values={
                "last_name":"",
                 "first_name":"",
                  "middle_name":"", 
